...
export const TEMPLATE_EVENTS: Record<string, WeddingEvent[]> = {
  southindian: [
    ...
    { id: 'cocktail-night', name: 'Cocktail Night', emoji: '🍸', image: `${IMG}/engagement2.webp`, date: 'December 10, 2026', time: '9:00 PM', venue: 'Nair Residence', venueAddress: 'Pattom, Thiruvananthapuram, Kerala', venueMapLink: '', description: '', color: '#c9a84c', hidden: true },
  ...
  invitation: [
    ...
    { id: 'cocktail-night', name: 'Cocktail Night', emoji: '🍸', image: `${IMG}/engagement2.webp`, date: 'October 15, 2026', time: '9:00 PM', venue: 'The Oberoi', venueAddress: 'Dr. Zakir Hussain Marg, Delhi', venueMapLink: '', description: '', color: '#c49a6c', hidden: true },
  ...
  template2: [
    ...
    { id: 'cocktail-night', name: 'Cocktail Night', emoji: '🍸', image: `${IMG}/engagement2.webp`, date: 'October 20, 2026', time: '9:00 PM', venue: 'The Grand Palace', venueAddress: 'MG Road, Mumbai', venueMapLink: '', description: '', color: '#c0425c', hidden: true },
  ...
  template3: [
    ...
    { id: 'cocktail-night', name: 'Cocktail Night', emoji: '🍸', image: `${IMG}/engagement2.webp`, date: 'November 10, 2026', time: '9:00 PM', venue: 'The Taj', venueAddress: 'Connaught Place, Delhi', venueMapLink: '', description: '', color: '#c4683a', hidden: true },
  ...
  template4: [
    ...
    { id: 'cocktail-night', name: 'Cocktail Night', emoji: '🍸', image: `${IMG}/engagement2.webp`, date: 'November 5, 2026', time: '9:00 PM', venue: 'Heritage Haveli', venueAddress: 'Jaipur', venueMapLink: '', description: '', color: '#c8922a', hidden: true },
  ...
  punjabi: [
    ...
    { id: 'cocktail-night', name: 'Cocktail Night', emoji: '🍸', image: `${IMG}/engagement2.webp`, date: 'November 1, 2026', time: '9:00 PM', venue: 'Home', venueAddress: 'Chandigarh', venueMapLink: '', description: '', color: '#e8a820', hidden: true },
  ...
  christian: [
    ...
    { id: 'cocktail-night', name: 'Cocktail Night', emoji: '🍸', image: `${IMG}/engagement2.webp`, date: 'February 12, 2027', time: '9:00 PM', venue: 'Seaside Pavilion', venueAddress: 'Baga Beach Road, Goa', venueMapLink: '', description: 'Cocktails under the stars.', color: '#1a8a9a', hidden: true },
  ...
  mandala: [
    ...
    { id: 'cocktail-night', name: 'Cocktail Night', emoji: '🍸', image: `${IMG}/engagement2.webp`, date: 'November 10, 2026', time: '9:00 PM', venue: 'Amer Fort', venueAddress: 'Jaipur', venueMapLink: '', description: '', color: '#d4a830', hidden: true },
