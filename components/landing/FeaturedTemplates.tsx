  ...
  return (
    <section className="py-24 overflow-hidden relative">
      <div className="absolute inset-0 pointer-events-none"
        style={{ background: 'linear-gradient(180deg, var(--color-bg) 0%, var(--color-surface) 15%, var(--color-surface) 85%, var(--color-bg) 100%)' }} />
      ...
      <div className="relative z-10">
        <motion.div className="max-w-6xl mx-auto px-6 text-center mb-14"
          ...
          <h2 className="font-display text-3xl md:text-4xl mb-3">Our Templates</h2>
            ...
            {doubled.map((t, i) => (
              <div key={`${t.id}-${i}`} className="flex-shrink-0 w-[200px]">
                <div className="rounded-[24px] overflow-hidden shadow-2xl relative"
                  style={{ aspectRatio: '9/16', background: t.color, border: '2px solid rgba(255,255,255,0.08)' }}>
